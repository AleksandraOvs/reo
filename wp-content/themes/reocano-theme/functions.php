...
function site_scripts(){
	...
	wp_enqueue_style( 'fonts-styles', get_stylesheet_directory_uri() . '/css/fonts.css', array(), time() );
...
function true_breadcrumbs(){
	...
	if( is_front_page() ){
		...
		} elseif ( is_archive() ){ // страницы WordPress 
...
## заменим слово "записи" на "Блог" для типа записей 'post'
